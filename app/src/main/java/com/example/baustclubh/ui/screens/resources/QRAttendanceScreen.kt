...
//        ) {
//            // ১. ইউজার কিউআর কোড সেকশন (স্ক্রিনশট অনুযায়ী)
//            Card(
...
//                    ) {
//                        Text("🔳", fontSize = 100.sp) // এখানে আসল QR লাইব্রেরি বসবে
//                    }
//
//                    Spacer(modifier = Modifier.height(16.dp))
//                    Text("STU-0802-4102-1070", color = PrimaryBlue, fontWeight = FontWeight.Bold)
...
//
//            // ২. রিসেন্ট অ্যাটেনডেন্স বা লাইভ ইভেন্ট লিস্ট
